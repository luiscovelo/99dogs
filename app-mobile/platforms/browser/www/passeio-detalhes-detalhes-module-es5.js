  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["passeio-detalhes-detalhes-module"], {
    ...
    function srcAppPasseioDetalhesDetalhesPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var DetalhesPage = /*#__PURE__*/function () {
        function DetalhesPage(geolocation, activatedRoute, router, passeioService, platform) {
        ...
        _createClass(DetalhesPage, [{
          ...
          value: function iniciarPasseio() {
            ...
            watch.subscribe(function (data) {
              _this2.latitude = data["coords"]["latitude"];
              _this2.longitude = data["coords"]["longitude"];

              _this2.passeioService.postLocalizacaoPasseio(_this2.latitude, _this2.longitude, _this2.passeio["id"]).subscribe();
            });
          }
        }, {
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 4:
                      this.activatedRoute.params.forEach(function (param) {
                        return _this3.passeioId = param['id'];
                      });

                      try {
                        this.passeioService.getDetalhes(this.passeioId).subscribe(function (response) {
                          _this3.passeio = response;
                          _this3.cliente = response["cliente"]["pessoa"];
                        });
                      } catch (error) {
                        console.log(error);
                      }
          ...
          value: function loadMap() {
            ...
            polyline.on(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_5__["GoogleMapsEvent"].POLYLINE_CLICK).subscribe(function (params) {
