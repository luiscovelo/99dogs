...
let DetalhesPage = class DetalhesPage {
    constructor(geolocation, activatedRoute, router, passeioService, platform) {
    ...
    loadMap() {
        ...
        let polyline = this.map.addPolylineSync({
            points: AIR_PORTS,
            color: '#AA00FF',
            width: 10,
            geodesic: true,
        ...
        polyline.on(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_5__["GoogleMapsEvent"].POLYLINE_CLICK).subscribe((params) => {
